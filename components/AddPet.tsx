...
export default function AddPet() {
    const handleSubmit = async (prevState: ActionResponse, formData: FormData) => {
        try {
    ...
    return (
        <Dialog>
            ...
            <DialogContent>
                ...
                <FormError className="text-red-500">{state.error ? state.error : null}</FormError>
                <Form className="grid gap-2" action={formAction}>
                    ...
                    <FormGroup className="grid grid-cols-2 gap-3">
                        <FormGroup className="grid gap-2">
                            ...
                            <Input id="age" name="age" type="text" placeholder="Age" required disabled={isPending} />
                        </FormGroup>
                        <FormGroup className="grid gap-2 w-full">
                            <FormLabel>Sex</FormLabel>
                            <Select name="sex" required disabled={isPending}>
                                <SelectTrigger>
                    ...
                    <Button variant={'default'} className="mt-4">
                        {isPending ? <Loader2Icon className="animate-spin" /> : <span>Save</span>}
                    </Button>
                </Form>
            </DialogContent>
        </Dialog>
